...
// local module files.
//
// Use this method if you want other source file extension than ".z".
//
//	// this will search for *.z, *.foo, *.bar
//	err := c.SetImportFileExt(".z", ".foo", ".bar")
//
